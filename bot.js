...
client.on('message', message => {
    if (message.content === '5help') {
        ...
        .addField('5vol', ' لرفع الصوت')
        .addField('5ping', 'لرؤية بنق البوت')
        .addField('5skip', 'تخطي الأغنية')
        .addField('5pause', 'ايقاف الاغنية مؤقتا')
        .addField('5resume', 'تكملة الاغنية')
        .addField('5queue', 'اظهار قائمة التشغيل')
        .addField('5np', 'اظهار الاغنية اللي انت مشغلها حاليا')
...
client.on('ready', function(){    
    var ms = 40000 ;    
    var setGame = [`HelklR| 5play`,"5play"];    
    var i = -1;    
    var j = 0;    
